                    ...
                    function(t, e, n, o) {
                        ...
                        let y = function(t, e, n) {
                                ...
                                return function(t, e, n) {
                                    ...
                                    for (let t = 0; t < s; t++) {
                                        let e = t < g ? p : m;
                                        A[t] = B.slice(w, w + e), C[t] = y.encode(A[t]), w += e, N = Math.max(N, e)
                                    }
                                    let I = new Uint8Array(a),
                                        M = 0;
                                    for (o = 0; o < N; o++)
                                        for (i = 0; i < s; i++) o < A[i].length && (I[M++] = A[i][o]);
                                    for (o = 0; o < E; o++)
                                        for (i = 0; i < s; i++) I[M++] = C[i][o];
                                    return I
                                }(o, t, e)
                            }(e, n, g),
                            w = r.getSymbolSize(e),
